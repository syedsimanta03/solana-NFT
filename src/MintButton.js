...
const MintButton = () => {
  ...
  const renderNotConnectedContainer = () => (
    <button className="rounded-2xl mint-button my-auto h-100 py-[13px] via-teal-600 to-indigo-500 bg-size-200 bg-pos-0 px-4 py-2 font-semibold shadow-lg shadow-white/10 transition-all duration-300 hover:bg-pos-100" 
